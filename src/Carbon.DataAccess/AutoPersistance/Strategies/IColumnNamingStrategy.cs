namespace NHibernate.Carbon.AutoPersistance.Strategies
{
    /// <summary>
    ...
    {
        /// <summary>
        /// This will create the column name based on the current property type.
        /// </summary>
        ...
        /// <returns></returns>
        string Execute(string propertyName, System.Type propertyType);
    }
}