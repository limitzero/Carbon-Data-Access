...
namespace NHibernate.Carbon.AutoPersistance.Core
{
	...
	{
		private readonly IList<System.Type> _entities = new List<System.Type>();
		private readonly Hashtable _joinTableNames = new Hashtable();

		public Inflector()
			: this(new List<System.Type>())
		{

		}

		public Inflector(IList<System.Type> entities)
		{
			_entities = entities;
		}
		...
		public string BuildVersionDefinition(ModelConvention convention, System.Type entity)
		{
			string results = string.Empty;

			if (convention.Versioning != null)
			{
				var builder = new VersionDeclarationBuilder { Convention = convention, Entity = entity };
		...
		public string BuildJoinTableName(ModelConvention convention, System.Type parentEntity, System.Type childEntity)
		{
			...
			foreach (DictionaryEntry de in _joinTableNames)
			{
				...
				{
					if(_joinTableNames.ContainsKey(key) == false)
					{
						_joinTableNames.Add(key, retval);
						break;
					}
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildEntityByConvention(ModelConvention convention, System.Type entity)
		{
			...
			document.Append("\r\n");
			document.Append(BuildVersionDefinition(convention, entity));
			document.Append("\r\n");
			...
			foreach (System.Type subclass in FindImplementorsOfBaseEntity(_entities, entity))
			{
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildPrimaryKeyForEntityByConvention(ModelConvention convention, System.Type entity)
		{
			string retval = string.Empty;
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildPropertiesForEntityByConvention(ModelConvention convention, System.Type entity)
		{
			string retval = string.Empty;
			var _properties = new List<PropertyInfo>();

			PropertyInfo[] properties = entity.GetProperties();
			System.Type baseType = entity.BaseType;
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildEntityRelationshipByConvention(ModelConvention convention, System.Type entity)
		{
			string results = string.Empty;
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildEntityRelationshipByConventionEx(ModelConvention convention, System.Type entity)
		{
			string retval = string.Empty;
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildComponentForEntityByConvention(ModelConvention convention, System.Type entity)
		{
			string retval = string.Empty;
			StringBuilder builder = new StringBuilder();
		...
		/// <param name="entity"></param>
		/// <returns></returns>
		public string BuildSubClassForEntityByConvention(ModelConvention convention, System.Type entity, System.Type parentEntity)
		{
			string retval = string.Empty;
			StringBuilder builder = new StringBuilder();
		...
		private IList<PropertyInfo> GetEntityProperties(System.Type entity)
		{
		...
		private bool IsComponent(ModelConvention convention, System.Type entity)
		{
			bool retval = false;
			if (entity.GetProperty(convention.PrimaryKey.PrimaryKeyName) == null
		...
		private bool IsSubClass(ModelConvention convention, System.Type entity)
		{
			bool retval = false;
			if (entity.BaseType != null)
			{
		...
		private IList<System.Type> FindBaseEntities(IList<System.Type> entities)
		{
			IList<System.Type> retval = new List<System.Type>();
			foreach (System.Type type in entities)
			{
		...
		private IList<System.Type> FindImplementorsOfBaseEntity(IList<System.Type> entities, System.Type baseEntity)
		{
			IList<System.Type> retval = new List<System.Type>();
			foreach (System.Type type in entities)
			{
		...
		/// <returns></returns>
		private System.Type GetTypeForName(string name, Assembly assemblyToScan)
		{
			System.Type retval = null;
			foreach (System.Type type in assemblyToScan.GetTypes())
			{
				if (type.Name == name)
				{
					retval = type;
		...
		private bool IsOneToOne(ModelConvention convention, IList<PropertyInfo> properties, System.Type entity, out System.Type childEntity, out string entityPropertyName)
		{
			...
			if (hasPrimaryKey)
			{
				foreach (PropertyInfo property in properties)
				{
					...
					else if (property.PropertyType.FullName.Contains("[]"))
					{
						...
						{
							System.Type type = property.PropertyType.Assembly.GetTypes()[i];
							if (type.Name == parentEntityName && !IsComponent(convention, type))
							{
								childEntity = type;
								hasCollectionProperties = true;
			...
			if (childEntity == null & !hasCollectionProperties)
			{
				foreach (PropertyInfo property in properties)
				{
					...
					{
						System.Type type = entity.Assembly.GetTypes()[index];
		...
		private RelationshipDefinition IsManyTo(ModelConvention convention, PropertyInfo property, System.Type entity)
		{
		...
		private System.Type FindTypeForField(ModelConvention convention, System.Type entity, string propertyName)
		{
			return null;
		}
	}
	...
	public class RelationshipDefinition
	{
		...
		private System.Type _referencedentity;
		public System.Type ReferencedEntity
		{
		...
		private string MakeQualifiedName(System.Type entity)
		{
			this._qualifiedName =  CreateQualifiedName(entity);
