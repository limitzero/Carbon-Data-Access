...
namespace Carbon.Repository.ForTesting
{
    /// <summary>
    ...
    ///          // AutoPersistanceModel model  = new AutoPeristanceModel(); //uses defaults for conventions from LocalConventionProvider
    ///
    ...
    ///          // when  you are satisfied with the mapping files, be sure to subsitute the line model.CacheMappings() for the line above.
    ///
    ///          return model;
    ///      }
    ///     
    ...
    public abstract class BaseAutoPersistanceTestFixture
    {
        ...
        public void OneTimeInitalizeWithModel(AutoPersistanceModel model)
        {
            // configure NHibernate based on the assemblies:
            try
            {
